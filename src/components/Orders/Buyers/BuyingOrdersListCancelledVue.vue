...
import BuyingOrdersCardCancelledVue from "./BuyingOrdersCardCanelled.vue";
...
export default defineComponent({
  ...
  mounted() {
    ...
    axios
      .get(
        `${endPoints.ordersUrl}/orders/buyer/cancelled/${store.getters.getUserId}`,
        {
          headers: {
