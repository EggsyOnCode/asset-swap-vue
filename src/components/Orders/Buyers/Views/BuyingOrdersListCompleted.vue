...
<script lang="ts">
import BuyerOrderCardCompletedVue from "../BuyerOrderCardCompleted.vue";
...
export default defineComponent({
  ...
  mounted() {
    ...
    axios
      .get(
        `${endPoints.ordersUrl}/orders/buyer/completed/${store.getters.getUserId}`,
        {
          headers: {
