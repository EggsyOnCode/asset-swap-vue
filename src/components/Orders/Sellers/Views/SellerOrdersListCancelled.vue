...
import SellerOrderCardCancelledVue from "../SellerOrderCardCancelled.vue";
...
export default defineComponent({
  ...
  mounted() {
    ...
    axios
      .get(
        `${endPoints.ordersUrl}/orders/seller/cancelled/${store.getters.getUserId}`,
        {
          headers: {
